  ...
  return (
    <div className="App min-h-screen flex flex-col gap-6 justify-center md:w-[400px] w-full md:text-base text-xl px-4">
      ...
      <div className='flex items-center w-full h-1/4'>
        ...
        {Number(value) > 0 ? (
          <div className='flex p-4 flex-row justify-between w-full bg-stone-300 rounded-md'>
...
<div className='absolute bottom-0 text-xs py-2'>
  <div className='flex justify-center items-center gap-1 text-purple-900'>
